...
rtimbl is a Ruby interface to the C++ library machine-learning library Timbl.  This is very much a work in progress.  If you happen to come across this, keep that in mind.

= installation

    sudo gem install rtimbl
